...
<!-- Twitter Card tags -->
    ...
    <meta name="twitter:image" content="{{ asset('assets/img/encyclopedia/'.$id. '/social/1024.jpg') }}">
<!-- Facebook Card tags -->
    <meta property="og:title" content="{{ $title }}">
    <meta property="og:description"
          content="{{ $desc }}">
    <meta property="og:image"
          content="{{ asset('assets/img/encyclopedia/'.$id. '/social/630.jpg') }}">
    ...
    <script type="application/ld+json">
      {
        ...
        "image": {
          "@type": "ImageObject",
          "url": "{{ asset('assets/img/encyclopedia/'.$id. '/social/1024.jpg') }}",
          "height": 512,
          "width": 1024
        }
      }
...
<amp-position-observer  on="scroll:blackmirror.seekTo(percent=event.percent)" layout="nodisplay"></amp-position-observer>
  ...
  {{ asset('assets/img/encyclopedia/'.$id. '/start/70.webp') }} 70w,
  {{ asset('assets/img/encyclopedia/'.$id. '/start/456.webp') }} 456w,
  {{ asset('assets/img/encyclopedia/'.$id. '/start/709.webp') }} 709w,
  {{ asset('assets/img/encyclopedia/'.$id. '/start/887.webp') }} 887w,
  {{ asset('assets/img/encyclopedia/'.$id. '/start/1000.webp') }} 1000w" src="{{ asset('assets/img/encyclopedia/'.$id. '/start/1000.webp') }}" height="1298" width="1000">
    <amp-img fallback alt="{{ $title }}" class="mobile layer-black" layout="responsive" srcset="
    {{ asset('assets/img/encyclopedia/'.$id. '/start/70.jpg') }} 70w,
    {{ asset('assets/img/encyclopedia/'.$id. '/start/456.jpg') }} 456w,
    {{ asset('assets/img/encyclopedia/'.$id. '/start/709.jpg') }} 709w,
    {{ asset('assets/img/encyclopedia/'.$id. '/start/887.jpg') }} 887w,
    {{ asset('assets/img/encyclopedia/'.$id. '/start/1000.jpg') }} 1000w" src="{{ asset('assets/img/encyclopedia/'.$id. '/start/1000.jpg') }}" height="1298" width="1000">
    </amp-img>
    </amp-img>
    <amp-img alt="{{ $title }}" class="desktop layer-black" layout="responsive" srcset="
    {{ asset('assets/img/encyclopedia/'.$id. '/social/200.webp') }} 200w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/490.webp') }} 490w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/690.webp') }} 690w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/888.webp') }} 888w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/1024.webp') }} 1024w" src="{{ asset('assets/img/encyclopedia/'.$id. '/social/1024.webp') }}" height="512" width="1024">
    <amp-img fallback alt="{{ $title }}" class="desktop layer-black" layout="responsive" srcset="
    {{ asset('assets/img/encyclopedia/'.$id. '/social/200.jpg') }} 200w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/490.jpg') }} 490w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/690.jpg') }} 690w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/888.jpg') }} 888w,
    {{ asset('assets/img/encyclopedia/'.$id. '/social/1024.jpg') }} 1024w" src="{{ asset('assets/img/encyclopedia/'.$id. '/social/1024.jpg') }}" height="512" width="1024">
    </amp-img></amp-img>
</div>
            ...
            <div class="lightbox" on="tap:my-lightbox.close" role="button" tabindex="0">
              <div class="lightcont">
                ...
                <div class="mwidth1">
                    ...
                    <amp-social-share class="rounded" type="pinterest" data-param-media="{{ asset('assets/img/encyclopedia/'.$id. '/social/1024.jpg') }}" width="48" height="48"></amp-social-share>
