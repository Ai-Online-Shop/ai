...
@slot('seo')
    <title>Encyclopedia Overview | Ai-Online-Shop.com</title>
    <meta name="description" content="Welcome to our Encyclopedia Overview Section">
@endslot
...
<amp-position-observer  on="scroll:blackmirror.seekTo(percent=event.percent)" layout="nodisplay"></amp-position-observer>
  <div class="overflow-container">
    <div id="blackmirror">
      <amp-img alt="encyclopedia Overview Ai-Online-Shop.com" class="mobile layer-black" layout="responsive" srcset="
    ...
    <amp-img fallback alt="encyclopedia Overview Ai-Online-Shop.com" class="mobile layer-black" layout="responsive" srcset="
    ...
    <amp-img alt="encyclopedia Overview Ai-Online-Shop.com" class="desktop layer-black" layout="responsive" srcset="
    ...
    <amp-img fallback alt="encyclopedia Overview Ai-Online-Shop.com" class="desktop layer-black" layout="responsive" srcset="
...
<amp-position-observer  on="scroll:blogphototext.seekTo(percent=event.percent)" layout="nodisplay"></amp-position-observer>
    ...
    <h1 class="header-text">Encyclopedia Overview</h1>
    </div>
  </div>
</div>
